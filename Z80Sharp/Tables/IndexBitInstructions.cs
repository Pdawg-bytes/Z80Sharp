    ...
    public unsafe partial class Z80
    {
        ...
        private void ExecuteIndexRBitInstruction(ref ushort indexAddressingMode)
        {
            ...
            switch (instruction)
            {
                ...
                case 0x03: RLC_IRDMEM_R(displacement, ref indexAddressingMode, ref Registers.E); break; // RLC (IR + d), E | UNDOCUMENTED
                case 0x04: RLC_IRDMEM_R(displacement, ref indexAddressingMode, ref Registers.H); break; // RLC (IR + d), H | UNDOCUMENTED
                case 0x05: RLC_IRDMEM_R(displacement, ref indexAddressingMode, ref Registers.L); break; // RLC (IR + d), L | UNDOCUMENTED
                case 0x07: RLC_IRDMEM_R(displacement, ref indexAddressingMode, ref Registers.A); break; // RLC (IR + d), A | UNDOCUMENTED
                case 0x06: RLC_IRDMEM(displacement, ref indexAddressingMode); break;                    // RLC (IR + d)

                case 0x10: RL_IRDMEM_R(displacement, ref indexAddressingMode, ref Registers.B); break; // RL (IR + d), B | UNDOCUMENTED
                case 0x11: RL_IRDMEM_R(displacement, ref indexAddressingMode, ref Registers.C); break; // RL (IR + d), C | UNDOCUMENTED
                case 0x12: RL_IRDMEM_R(displacement, ref indexAddressingMode, ref Registers.D); break; // RL (IR + d), D | UNDOCUMENTED
                case 0x13: RL_IRDMEM_R(displacement, ref indexAddressingMode, ref Registers.E); break; // RL (IR + d), E | UNDOCUMENTED
                case 0x14: RL_IRDMEM_R(displacement, ref indexAddressingMode, ref Registers.H); break; // RL (IR + d), H | UNDOCUMENTED
                case 0x15: RL_IRDMEM_R(displacement, ref indexAddressingMode, ref Registers.L); break; // RL (IR + d), L | UNDOCUMENTED
                case 0x17: RL_IRDMEM_R(displacement, ref indexAddressingMode, ref Registers.A); break; // RL (IR + d), A | UNDOCUMENTED
                ...
                case 0x0B: RRC_IRDMEM_R(displacement, ref indexAddressingMode, ref Registers.E); break; // RRC (IR + d), E | UNDOCUMENTED
                case 0x0C: RRC_IRDMEM_R(displacement, ref indexAddressingMode, ref Registers.H); break; // RRC (IR + d), H | UNDOCUMENTED
                case 0x0D: RRC_IRDMEM_R(displacement, ref indexAddressingMode, ref Registers.L); break; // RRC (IR + d), L | UNDOCUMENTED
                case 0x0F: RRC_IRDMEM_R(displacement, ref indexAddressingMode, ref Registers.A); break; // RRC (IR + d), A | UNDOCUMENTED
                case 0x0E: RRC_IRDMEM(displacement, ref indexAddressingMode); break;                    // RRC (IR + d)

                case 0x18: RR_IRDMEM_R(displacement, ref indexAddressingMode, ref Registers.B); break; // RR (IR + d), B | UNDOCUMENTED
                case 0x19: RR_IRDMEM_R(displacement, ref indexAddressingMode, ref Registers.C); break; // RR (IR + d), C | UNDOCUMENTED
                case 0x1A: RR_IRDMEM_R(displacement, ref indexAddressingMode, ref Registers.D); break; // RR (IR + d), D | UNDOCUMENTED
                case 0x1B: RR_IRDMEM_R(displacement, ref indexAddressingMode, ref Registers.E); break; // RR (IR + d), E | UNDOCUMENTED
                case 0x1C: RR_IRDMEM_R(displacement, ref indexAddressingMode, ref Registers.H); break; // RR (IR + d), H | UNDOCUMENTED
                case 0x1D: RR_IRDMEM_R(displacement, ref indexAddressingMode, ref Registers.L); break; // RR (IR + d), L | UNDOCUMENTED
                case 0x1F: RR_IRDMEM_R(displacement, ref indexAddressingMode, ref Registers.A); break; // RR (IR + d), A | UNDOCUMENTED
                ...
                case 0x23: SLA_IRDMEM_R(displacement, ref indexAddressingMode, ref Registers.E); break; // SLA (IR + d), E | UNDOCUMENTED
                case 0x24: SLA_IRDMEM_R(displacement, ref indexAddressingMode, ref Registers.H); break; // SLA (IR + d), H | UNDOCUMENTED
                case 0x25: SLA_IRDMEM_R(displacement, ref indexAddressingMode, ref Registers.L); break; // SLA (IR + d), L | UNDOCUMENTED
                case 0x27: SLA_IRDMEM_R(displacement, ref indexAddressingMode, ref Registers.A); break; // SLA (IR + d), A | UNDOCUMENTED
                case 0x26: SLA_IRDMEM(displacement, ref indexAddressingMode); break;                    // SLA (IR + d)

                case 0x30: SLL_IRDMEM_R(displacement, ref indexAddressingMode, ref Registers.B); break; // SLL (IR + d), B | UNDOCUMENTED
                case 0x31: SLL_IRDMEM_R(displacement, ref indexAddressingMode, ref Registers.C); break; // SLL (IR + d), C | UNDOCUMENTED
                case 0x32: SLL_IRDMEM_R(displacement, ref indexAddressingMode, ref Registers.D); break; // SLL (IR + d), D | UNDOCUMENTED
                case 0x33: SLL_IRDMEM_R(displacement, ref indexAddressingMode, ref Registers.E); break; // SLL (IR + d), E | UNDOCUMENTED
                case 0x34: SLL_IRDMEM_R(displacement, ref indexAddressingMode, ref Registers.H); break; // SLL (IR + d), H | UNDOCUMENTED
                case 0x35: SLL_IRDMEM_R(displacement, ref indexAddressingMode, ref Registers.L); break; // SLL (IR + d), L | UNDOCUMENTED
                case 0x37: SLL_IRDMEM_R(displacement, ref indexAddressingMode, ref Registers.A); break; // SLL (IR + d), A | UNDOCUMENTED
                ...
                case 0x3A: SRL_IRDMEM_R(displacement, ref indexAddressingMode, ref Registers.D); break; // SRL (IR + d), D | UNDOCUMENTED
