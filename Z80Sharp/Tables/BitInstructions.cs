    ...
    public unsafe partial class Z80
    {
        ...
        private void ExecuteBitInstruction()
        {
            ...
            switch (instruction)
            {
                ...
                case 0x06: RLC_RRMEM(ref Registers.HL); break; // RLC (HL)
                ...
                case 0x16: RL_RRMEM(ref Registers.HL); break; // RL (HL)
                ...
                case 0x0E: RRC_RRMEM(ref Registers.HL); break; // RRC (HL)
                ...
                case 0x1E: RR_RRMEM(ref Registers.HL); break; // RR (HL)
                ...
                case 0x26: SLA_RRMEM(ref Registers.HL); break; // SLA (HL)
                ...
                case 0x36: SLL_RRMEM(ref Registers.HL); break; // SLL (HL) | UNDOCUMENTED
                ...
                case 0x2E: SRA_RRMEM(ref Registers.HL); break; // SRA (HL)
                ...
                case 0x3E: SRL_RRMEM(ref Registers.HL); break; // SRL (HL)
                ...
                case 0x46: BIT_B_RRMEM(0, ref Registers.HL); break; // BIT 0, (HL)
                ...
                case 0x4E: BIT_B_RRMEM(1, ref Registers.HL); break; // BIT 1, (HL)
                ...
                case 0x56: BIT_B_RRMEM(2, ref Registers.HL); break; // BIT 2, (HL)
                ...
                case 0x5E: BIT_B_RRMEM(3, ref Registers.HL); break; // BIT 3, (HL)
                ...
                case 0x66: BIT_B_RRMEM(4, ref Registers.HL); break; // BIT 4, (HL)
                ...
                case 0x76: BIT_B_RRMEM(6, ref Registers.HL); break; // BIT 6, (HL)
                ...
                case 0x86: RES_B_RRMEM(0, ref Registers.HL); break; // RES 0, (HL)
                ...
                case 0x8E: RES_B_RRMEM(1, ref Registers.HL); break; // RES 1, (HL)
                ...
                case 0x96: RES_B_RRMEM(2, ref Registers.HL); break; // RES 2, (HL)
                ...
                case 0x9E: RES_B_RRMEM(3, ref Registers.HL); break; // RES 3, (HL)
                ...
                case 0xA6: RES_B_RRMEM(4, ref Registers.HL); break; // RES 4, (HL)
                ...
                case 0xC6: SET_B_RRMEM(0, ref Registers.HL); break; // SET 0, (HL)
                ...
                case 0xCE: SET_B_RRMEM(1, ref Registers.HL); break; // SET 1, (HL)
                ...
                case 0xD6: SET_B_RRMEM(2, ref Registers.HL); break; // SET 2, (HL)
                ...
                case 0xDE: SET_B_RRMEM(3, ref Registers.HL); break; // SET 3, (HL)
                ...
                case 0xE6: SET_B_RRMEM(4, ref Registers.HL); break; // SET 4, (HL)
