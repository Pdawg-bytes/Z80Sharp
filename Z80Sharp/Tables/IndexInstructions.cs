...
namespace Z80Sharp.Processor
{
    public unsafe partial class Z80
    {
        ...
        private void ExecuteIndexRInstruction(ref ushort indexAddressingMode)
        {
            ...
            switch (instruction)
            {
                case 0xCB: ExecuteIndexRBitInstruction(ref indexAddressingMode); break; // IndexR Bit

                // AD(D/C) instructions: ADD register and operand (+ carry if ADC).
                case 0x09: ADD_IR_RR(ref indexAddressingMode, ref Registers.BC); break; // ADD IR, BC
                case 0x19: ADD_IR_RR(ref indexAddressingMode, ref Registers.DE); break; // ADD IR, DE
                case 0x29: ADD_IR_RR(ref indexAddressingMode, ref Registers.HL); break; // ADD IR, HL
                case 0x39: ADD_IR_RR(ref indexAddressingMode, ref Registers.SP); break; // ADD IR, SP
                ...
                //case 0x84: ADD_A_R(indexAddressingMode); break;       // ADD A, IRh | UNDOCUMENTED
                //case 0x85: ADD_A_R((byte)(indexAddressingMode + 1)); break; // ADD A, IRl | UNDOCUMENTED
                case 0x86: ADD_A_IRDMEM(ref indexAddressingMode); break;  // ADD A, (IR + d)
                ...
                //case 0x8C: ADC_A_R(indexAddressingMode); break;       // ADC A, H | UNDOCUMENTED
                //case 0x8D: ADC_A_R((byte)(indexAddressingMode + 1)); break; // ADC A, L | UNDOCUMENTED
                case 0x8E: ADC_A_IRDMEM(ref indexAddressingMode); break;  // ADC A, (IR + d)
                ...
                //case 0x94: SUB_R(indexAddressingMode); break;       // SUB IRh | UNDOCUMENTED
                ...
                //case 0x9C: SBC_A_R(indexAddressingMode); break;       // SBC A, IRh | UNDOCUMENTED
                //case 0x9D: SBC_A_R((byte)(indexAddressingMode + 1)); break; // SBC A, IRl | UNDOCUMENTED
                case 0x9E: SBC_A_IRDMEM(ref indexAddressingMode); break;  // SBC A, (IR + d)
                ...
                //case 0xB4: OR_R(indexAddressingMode); break;       // OR IRh | UNDOCUMENTED
                //case 0xB5: OR_R((byte)(indexAddressingMode + 1)); break; // OR IRh | UNDOCUMENTED
                case 0xB6: OR_IRDMEM(ref indexAddressingMode); break;  // OR (IR + d)
                ...
                //case 0xAC: XOR_R(indexAddressingMode); break;       // XOR IRh | UNDOCUMENTED
                //case 0xAD: XOR_R((byte)(indexAddressingMode + 1)); break; // XOR IRl | UNDOCUMENTED
                case 0xAE: XOR_IRDMEM(ref indexAddressingMode); break;  // XOR (IR + d)
                ...
                //case 0xA4: AND_R(indexAddressingMode); break;       // AND IRh | UNDOCUMENTED
                //case 0xA5: AND_R((byte)(indexAddressingMode + 1)); break; // AND IRl | UNDOCUMENTED
                case 0xA6: AND_IRDMEM(ref indexAddressingMode); break;  // AND (IR + d)
                ...
                //case 0xBC: CMP_R(indexAddressingMode); break;       // CP IRh | UNDOCUMENTED
                //case 0xBD: CMP_R((byte)(indexAddressingMode + 1)); break; // CP IRl | UNDOCUMENTED
                case 0xBE: CMP_IRDMEM(ref indexAddressingMode); break;  // CP (IR + d)
                ...
                case 0x21: LD_RR_NN(ref indexAddressingMode); break;  // LD IR, NN
                case 0xF9: LD_RR_RR(ref Registers.SP, ref indexAddressingMode); break; // LD SP, IR
                ...
                //case 0x26: LD_R_N(indexAddressingMode); break;        // LD IRh, N | UNDOCUMENTED
                ...
                //case 0x44: LD_R_R(ref Registers.B, indexAddressingMode); break;       // LD B, IRh | UNDOCUMENTED
                //case 0x45: LD_R_R(ref Registers.B, (byte)(indexAddressingMode + 1)); break; // LD B, IRl | UNDOCUMENTED
                case 0x46: LD_R_IRDMEM(ref Registers.B, ref indexAddressingMode); break;  // LD B, (IR + d)
                ...
                //case 0x4C: LD_R_R(ref Registers.C, indexAddressingMode); break;       // LD C, IRh | UNDOCUMENTED
                //case 0x4D: LD_R_R(ref Registers.C, (byte)(indexAddressingMode + 1)); break; // LD C, IRl | UNDOCUMENTED
                case 0x4E: LD_R_IRDMEM(ref Registers.C, ref indexAddressingMode); break;  // LD C, (IR + d)
                ...
                //case 0x54: LD_R_R(ref Registers.D, indexAddressingMode); break;       // LD D, IRh | UNDOCUMENTED
                //case 0x55: LD_R_R(ref Registers.D, (byte)(indexAddressingMode + 1)); break; // LD D, IRl | UNDOCUMENTED
                case 0x56: LD_R_IRDMEM(ref Registers.D, ref indexAddressingMode); break;  // LD D, (IR + d)
                ...
                //case 0x5C: LD_R_R(ref Registers.E, indexAddressingMode); break;       // LD E, IRh | UNDOCUMENTED
                //case 0x5D: LD_R_R(ref Registers.E, (byte)(indexAddressingMode + 1)); break; // LD E, IRl | UNDOCUMENTED
                case 0x5E: LD_R_IRDMEM(ref Registers.E, ref indexAddressingMode); break;  // LD E, (IR + d)
                case 0x5F: LD_R_R(ref Registers.E, ref Registers.A); break;  // LD E, A | UNDOCUMENTED

                //case 0x60: LD_R_R(indexAddressingMode, ref Registers.B); break;  // LD IRh, B | UNDOCUMENTED
                //case 0x61: LD_R_R(indexAddressingMode, ref Registers.C); break;  // LD IRh, C | UNDOCUMENTED
                //case 0x62: LD_R_R(indexAddressingMode, ref Registers.D); break;  // LD IRh, D | UNDOCUMENTED
                //case 0x63: LD_R_R(indexAddressingMode, ref Registers.E); break;  // LD IRh, E | UNDOCUMENTED
                //case 0x64: LD_R_R(indexAddressingMode, ref Registers.H); break;  // LD IRh, H | UNDOCUMENTED
                //case 0x65: LD_R_R(indexAddressingMode, ref Registers.L); break;  // LD IRh, L | UNDOCUMENTED
                case 0x66: LD_R_IRDMEM(ref Registers.H, ref indexAddressingMode); break;  // LD H, (IR + d)
                //case 0x67: LD_R_R(indexAddressingMode, ref Registers.A); break;  // LD IRh, A | UNDOCUMENTED

                //case 0x68: LD_R_R((byte)(indexAddressingMode + 1), ref Registers.B); break;  // LD IRl, B | UNDOCUMENTED
                //case 0x69: LD_R_R((byte)(indexAddressingMode + 1), ref Registers.C); break;  // LD IRl, C | UNDOCUMENTED
                //case 0x6A: LD_R_R((byte)(indexAddressingMode + 1), ref Registers.D); break;  // LD IRl, D | UNDOCUMENTED
                //case 0x6B: LD_R_R((byte)(indexAddressingMode + 1), ref Registers.E); break;  // LD IRl, E | UNDOCUMENTED
                //case 0x6C: LD_R_R((byte)(indexAddressingMode + 1), ref Registers.H); break;  // LD IRl, H | UNDOCUMENTED
                //case 0x6D: LD_R_R((byte)(indexAddressingMode + 1), ref Registers.L); break;  // LD IRl, L | UNDOCUMENTED
                case 0x6E: LD_R_IRDMEM(ref Registers.L, ref indexAddressingMode); break;   // LD L, (IR + d)
                //case 0x6F: LD_R_R((byte)(indexAddressingMode + 1), ref Registers.A); break;  // LD IRl, A | UNDOCUMENTED
                ...
                //case 0x7C: LD_R_R(ref Registers.A, indexAddressingMode); break;       // LD A, IRh | UNDOCUMENTED
                //case 0x7D: LD_R_R(ref Registers.A, (byte)(indexAddressingMode + 1)); break; // LD A, IRl | UNDOCUMENTED
                case 0x7E: LD_R_IRDMEM(ref Registers.A, ref indexAddressingMode); break;  // LD A, (IR + d)
                case 0x7F: LD_R_R(ref Registers.A, ref Registers.A); break;  // LD A, A | UNDOCUMENTED

                case 0x70: LD_IRDMEM_R(ref indexAddressingMode, ref Registers.B); break;  // LD (IR + d), B
                case 0x71: LD_IRDMEM_R(ref indexAddressingMode, ref Registers.C); break;  // LD (IR + d), C
                case 0x72: LD_IRDMEM_R(ref indexAddressingMode, ref Registers.D); break;  // LD (IR + d), D
                case 0x73: LD_IRDMEM_R(ref indexAddressingMode, ref Registers.E); break;  // LD (IR + d), E
                case 0x74: LD_IRDMEM_R(ref indexAddressingMode, ref Registers.H); break;  // LD (IR + d), H
                case 0x75: LD_IRDMEM_R(ref indexAddressingMode, ref Registers.L); break;  // LD (IR + d), L
                case 0x77: LD_IRDMEM_R(ref indexAddressingMode, ref Registers.A); break;  // LD (IR + d), A
                case 0x36: LD_IRDMEM_N(ref indexAddressingMode); break; // LD (IR + d), N
                ...
                case 0xE1: POP_RR(ref indexAddressingMode); break;  // POP IR
                // PUSH instructions: push value in RR on to stack and dec. SP
                case 0xE5: PUSH_RR(ref indexAddressingMode); break; // PUSH IR


                // INC instructions: increments RR/R by 1.
                case 0x23: INC_RR(ref indexAddressingMode); break;     // INC IR
                case 0x34: INC_IRDMEM(ref indexAddressingMode); break; // INC (IR + d)
                ...
                //case 0x24: INC_R(indexAddressingMode); break;       // INC IRh | UNDOCUMENTED
                ...
                case 0x2B: DEC_RR(ref indexAddressingMode); break;     // DEC IR
                case 0x35: DEC_IRDMEM(ref indexAddressingMode); break; // DEC (IR + d)
                ...
                //case 0x25: DEC_R(indexAddressingMode); break;       // DEC IRh | UNDOCUMENTED
                ...
                case 0xE3: EX_SPMEM_IR(ref indexAddressingMode); break; // EX (SP), IR
