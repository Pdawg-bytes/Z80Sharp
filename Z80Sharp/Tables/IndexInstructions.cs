    ...
    public unsafe partial class Z80
    {
        ...
        private void ExecuteIndexRInstruction(byte indexAddressingMode)
        {
            ...
            switch (instruction)
            {
                ...
                case 0x09: ADD_IR_RR(indexAddressingMode, B); break;   // ADD IR, BC
                case 0x19: ADD_IR_RR(indexAddressingMode, D); break;   // ADD IR, DE
                case 0x29: ADD_IR_RR(indexAddressingMode, H); break;   // ADD IR, HL
                case 0x39: ADD_IR_RR(indexAddressingMode, SPi); break; // ADD IR, SP
                ...
                case 0x86: ADD_A_IRDMEM(indexAddressingMode); break;  // ADD A, (IR + d)
                ...
                case 0x8E: ADC_A_IRDMEM(indexAddressingMode); break;  // ADC A, (IR + d)
                ...
                case 0x96: SUB_IRDMEM(indexAddressingMode); break;  // SUB (IR + d)
                ...
                case 0x9E: SBC_A_IRDMEM(indexAddressingMode); break;  // SBC A, (IR + d)
                ...
                case 0xB6: OR_IRDMEM(indexAddressingMode); break;  // OR (IR + d)
                ...
                case 0xAE: XOR_IRDMEM(indexAddressingMode); break;  // XOR (IR + d)
                ...
                case 0xA6: AND_IRDMEM(indexAddressingMode); break;  // AND (IR + d)
                ...
                case 0xBE: CMP_IRDMEM(indexAddressingMode); break;  // CP (IR + d)
                case 0xBF: CMP_R(A); break;     // CP A | UNDOCUMENTED


                // LD instructions: Load/store values between/from registers or memory
                case 0x21: LD_RR_NN(indexAddressingMode); break;  // LD IR, NN
                case 0xF9: LD_RR_RR(SPi, indexAddressingMode); break; // LD SP, IR
                ...
                case 0x22: LD_NNMEM_RR(indexAddressingMode); break;   // LD (NN), IR
                case 0x2A: LD_RR_NNMEM(indexAddressingMode); break;   // LD IR, (NN)
                ...
                case 0x44: LD_R_R(B, indexAddressingMode); break;       // LD B, IRh | UNDOCUMENTED
                case 0x45: LD_R_R(B, (byte)(indexAddressingMode + 1)); break; // LD B, IRl | UNDOCUMENTED
                case 0x46: LD_R_IRDMEM(B, indexAddressingMode); break;  // LD B, (IR + d)
                ...
                case 0x4C: LD_R_R(C, indexAddressingMode); break;       // LD C, IRh | UNDOCUMENTED
                case 0x4D: LD_R_R(C, (byte)(indexAddressingMode + 1)); break; // LD C, IRl | UNDOCUMENTED
                case 0x4E: LD_R_IRDMEM(C, indexAddressingMode); break;  // LD C, (IR + d)
                ...
                case 0x54: LD_R_R(D, indexAddressingMode); break;       // LD D, IRh | UNDOCUMENTED
                case 0x55: LD_R_R(D, (byte)(indexAddressingMode + 1)); break; // LD D, IRl | UNDOCUMENTED
                case 0x56: LD_R_IRDMEM(D, indexAddressingMode); break;  // LD D, (IR + d)
                ...
                case 0x5C: LD_R_R(E, indexAddressingMode); break;       // LD E, IRh | UNDOCUMENTED
                case 0x5D: LD_R_R(E, (byte)(indexAddressingMode + 1)); break; // LD E, IRl | UNDOCUMENTED
                case 0x5E: LD_R_IRDMEM(E, indexAddressingMode); break;  // LD E, (IR + d)
                case 0x5F: LD_R_R(E, A); break;  // LD E, A | UNDOCUMENTED

                case 0x60: LD_R_R(indexAddressingMode, B); break;  // LD IRh, B | UNDOCUMENTED
                case 0x61: LD_R_R(indexAddressingMode, C); break;  // LD IRh, C | UNDOCUMENTED
                case 0x62: LD_R_R(indexAddressingMode, D); break;  // LD IRh, D | UNDOCUMENTED
                case 0x63: LD_R_R(indexAddressingMode, E); break;  // LD IRh, E | UNDOCUMENTED
                case 0x64: LD_R_R(indexAddressingMode, H); break;  // LD IRh, H | UNDOCUMENTED
                case 0x65: LD_R_R(indexAddressingMode, L); break;  // LD IRh, L | UNDOCUMENTED
                case 0x66: LD_R_IRDMEM(H, indexAddressingMode); break;  // LD H, (IR + d)
                case 0x67: LD_R_R(indexAddressingMode, A); break;  // LD IRh, A | UNDOCUMENTED
                ...
                case 0x6E: LD_R_IRDMEM(L, indexAddressingMode); break;   // LD L, (IR + d)
                ...
                case 0x7C: LD_R_R(A, indexAddressingMode); break;       // LD A, IRh | UNDOCUMENTED
                case 0x7D: LD_R_R(A, (byte)(indexAddressingMode + 1)); break; // LD A, IRl | UNDOCUMENTED
                case 0x7E: LD_R_IRDMEM(A, indexAddressingMode); break;  // LD A, (IR + d)
                case 0x7F: LD_R_R(A, A); break;  // LD A, A | UNDOCUMENTED

                case 0x70: LD_IRDMEM_R(indexAddressingMode, B); break;  // LD (IR + d), B
                case 0x71: LD_IRDMEM_R(indexAddressingMode, C); break;  // LD (IR + d), C
                case 0x72: LD_IRDMEM_R(indexAddressingMode, D); break;  // LD (IR + d), D
                case 0x73: LD_IRDMEM_R(indexAddressingMode, E); break;  // LD (IR + d), E
                ...
                case 0xE9: JP_RR(indexAddressingMode); break; // JP (IR)


                // POP instructions: pop value at SP into RR and inc. SP
                case 0xE1: POP_RR(indexAddressingMode); break;  // POP IR
                // PUSH instructions: push value in RR on to stack and dec. SP
                case 0xE5: PUSH_RR(indexAddressingMode); break; // PUSH IR


                // INC instructions: increments RR/R by 1.
                case 0x23: INC_RR(indexAddressingMode); break;     // INC IR
                case 0x34: INC_IRDMEM(indexAddressingMode); break; // INC (IR)
                ...
                case 0x2B: DEC_RR(indexAddressingMode); break;     // DEC IR
                case 0x35: DEC_IRDMEM(indexAddressingMode); break; // DEC (IR)
                ...
                case 0xE3: EX_SPMEM_IR(indexAddressingMode); break; // EX (SP), IR
